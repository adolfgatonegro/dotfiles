#+TITLE: GNU Emacs Configuration v2
#+AUTHOR: Gatonegro
#+STARTUP: content
...
#+RESULTS:
: [nil 26418 42605 756442 nil elpaca-process-queues nil nil 596000 nil]
...
Turns out I can get LSP functionality going by simply passing a couple of lines to =eglot=, instead of bringing in the whole mess of =lsp-mode=. Here, we do just that to enable support for =typst=.
...
Add support for =typst= using Tree-sitter.
